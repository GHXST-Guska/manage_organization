...
class PersonService {
  final String baseUrl =
      'https://simobile.singapoly.com/api/trpl/customer-service/2355011007';
  ...
  Future<List<Person>> fetchPersons() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception(
          'Failed to load persons (status: ${response.statusCode})',
        );
      }
    } catch (e) {
  ...
  Future<Person> fetchPerson(int id) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception(
          'Failed to load person (status: ${response.statusCode})',
        );
      }
    } catch (e) {
  ...
  Future<Person> createPersonWithImage({
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        throw Exception(
          'Failed to create person (status: ${response.statusCode})',
        );
      }
    } catch (e) {
